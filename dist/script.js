...
function tabs() {
  var blocks = document.querySelectorAll(".glazing_block");
  var rowBlocks = document.querySelectorAll(".glazing .row");
  ...
  blocks.forEach(function (item, i) {
    item.addEventListener("click", function (element) {
      ...
      rowBlocks[i].classList.remove("fadeOut"); // rowBlocks[i].style.display = "block";
    });
  });
}
