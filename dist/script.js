...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_2__["default"])(".popup_engineer_btn", ".popup_engineer", ".popup_engineer .popup_close");
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_2__["default"])(".phone_link", ".popup", ".popup .popup_close");
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_2__["default"])(".popup_calc_btn", ".popup_calc", ".popup_calc .popup_calc_close");
...
/***/ "./src/js/modules/checkNumbers.js":
/*!****************************************!*\
  !*** ./src/js/modules/checkNumbers.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return checkNumbers; });
/* harmony import */ var core_js_modules_es_string_replace__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.string.replace */ "./node_modules/core-js/modules/es.string.replace.js");
/* harmony import */ var core_js_modules_es_string_replace__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_string_replace__WEBPACK_IMPORTED_MODULE_0__);

function checkNumbers(numberField) {
...
/* harmony import */ var _checkNumbers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./checkNumbers */ "./src/js/modules/checkNumbers.js");
...
function form(state) {
  ...
  phoneNumber.forEach(function (number) {
    Object(_checkNumbers__WEBPACK_IMPORTED_MODULE_4__["default"])(number);
  });
...
function modal(triggerSelector, modalSelector, closeButton) {
  var closeClickOverlay = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
  var trigger = document.querySelectorAll(triggerSelector);
  var modal = document.querySelector(modalSelector);
  var closeBtn = document.querySelectorAll(closeButton);
  var allModals = document.querySelectorAll("[data-modal]");
  var marginR = calcScroll();

  function openModal() {
    modal.style.display = "block";
    document.body.style.marginRight = "".concat(marginR, "px"); // clearTimeout(modalTimer);  //не сработает, в каждой функции openModal создается свой таймер и свой modalTimer. Он не расшаривается между функциями по понятным причинам. И клик, обработанный в одной функции не может завершить "соседний" интервал. А во втором варианте один id на все операции и вы можете управлять им из любой функции.
  }
    ...
    trig.addEventListener("click", function (e) {
      ...
      if (trig.getAttribute("class") == "button popup_calc_button") {
        if (document.querySelector("#width").value && document.querySelector("#height").value) {
          ...
          openModal();
          document.body.style.overflow = "hidden";
          document.body.style.marginRight = "".concat(marginR, "px");
        }
        ...
        openModal();
        document.body.style.overflow = "hidden";
        document.body.marginRight = "".concat(marginR, "px");
      }
    });
  });
...
/***/ "./src/js/modules/setFormSettings.js":
/*!*******************************************!*\
  !*** ./src/js/modules/setFormSettings.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return setFormSettings; });
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _checkNumbers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./checkNumbers */ "./src/js/modules/checkNumbers.js");


function setFormSettings(formSettings) {
  var forms = document.querySelectorAll(".balcon_icons_img");
  var width = document.querySelectorAll("#width");
  var height = document.querySelectorAll("#height");
  var type = document.querySelectorAll("#view_type");
  var checkbox = document.querySelectorAll(".checkbox");
  width.forEach(function (number) {
    return Object(_checkNumbers__WEBPACK_IMPORTED_MODULE_1__["default"])(number);
  });
  height.forEach(function (number) {
    return Object(_checkNumbers__WEBPACK_IMPORTED_MODULE_1__["default"])(number);
  });

  function setSettings(selector, event, setting) {
    selector.forEach(function (form, i) {
        ...
        switch (event) {
          ...
          case "input":
            if (form.getAttribute("class") == "checkbox") {
              ...
              selector.forEach(function (box, j) {
                box.checked = false;
